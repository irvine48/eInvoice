...
class Invoice implements XmlSerializable
{
    ...
    public function xmlSerialize(Writer $writer): void
    {
        ...
        if ($this->invoiceTypeCode !== null) {
            ...
            // Write the InvoiceTypeCode element with attributes - 20240806
            $writer->startElement(Schema::CBC . $this->xmlTagName . 'TypeCode');
            $writer->writeAttribute('listVersionID', '1.0');
            $writer->text($this->invoiceTypeCode);
            $writer->endElement();
        }
        ...
        $writer->write([
            Schema::CBC . 'TaxCurrencyCode' => $this->documentCurrencyCode,
        ]);

        // if ($this->dueDate !== null) {
            $writer->write([
                Schema::CAC . 'InvoicePeriod' => [
                    Schema::CBC . 'StartDate' => date('Y-m-d'), // para
                    Schema::CBC . 'EndDate' => date('Y-m-d'), // para
                    Schema::CBC . 'Description' => 'Daily', // para
                ]
            ]);
        // }
        ...
        // Prepaid
        $writer->startElement(Schema::CAC . 'PrepaidPayment');

            $writer->startElement(Schema::CBC . 'ID');
            $writer->text('E12345678912');
            $writer->endElement();

            $writer->startElement(Schema::CBC . 'PaidAmount');
            $writer->writeAttribute('currencyID', 'MYR');
            $writer->text('1.00');
            $writer->endElement();

            $writer->startElement(Schema::CBC . 'PaidDate');
            $writer->text('2024-07-23');
            $writer->endElement();

            $writer->startElement(Schema::CBC . 'PaidTime');
            $writer->text('00:30:00Z');
            $writer->endElement();
